...
class GUI:
    def __init__(self, master):
        ...
        self.SongNameLabel = Label(
            master, textvariable=self.SongName, font=("EuroStyle", 45), anchor="center", bg=Black, fg=EDOrange
        )
        self.SongNameLabel.place(x=SONGINFOX, y=SONGINFOY + 20)
        self.SongArtist = StringVar("")
        self.SongArtistLabel = Label(
            master, textvariable=self.SongArtist, font=("EuroStyle", 15), anchor="center", bg=Black, fg=EDOrange
        )
        self.SongArtistLabel.place(x=SONGINFOX, y=SONGINFOY)

        # Status Symbols
        self.lastEvent = StringVar("")
        self.lastEventLabel = Label(
            master, textvariable=self.lastEvent, font=("EuroStyle", 15), anchor="center", bg=Black, fg=EDOrange
        )
        self.lastEventLabel.place(x=SONGINFOX + 200, y=SONGINFOY)
        self.currentMode = StringVar("")
        self.currentModeLabel = Label(
            master, textvariable=self.currentMode, font=("EuroStyle", 15), anchor="center", bg=Black, fg=EDOrange
        )
        self.currentModeLabel.place(x=SONGINFOX, y=SONGINFOY + 81)
        self.currentWorkingVolume = StringVar("")
        self.currentWorkingVolumeLabel = Label(
            master,
            textvariable=self.currentWorkingVolume,
            font=("EuroStyle", 15),
            anchor="center",
            bg=Black,
            fg=EDOrange,
        ...
        self.currentLoweredVolumeLabel = Label(
            master,
            textvariable=self.currentLoweredVolume,
            font=("EuroStyle", 15),
            anchor="center",
            bg=Black,
            fg=EDOrange,
        ...
        self.close_button = Button(
            ...
            border=0,
            pady=0,
            activebackground=EDOrange,
            activeforeground=EDOrangeHot,
        )
        self.close_button.place(x=0, y=0)
        self.pause_button = Button(
            master,
            text="Pause",
            command=self.EDSR.pause,
            font=("EuroStyle", 15),
            anchor="center",
            bg="black",
            fg=EDOrange,
        ...
        self.switch_provider_spotify_button = Button(
            master,
            text="Spotify",
            command=self.switchToSpotify,
            font=("EuroStyle", 15),
            anchor="center",
            bg="black",
            fg=EDOrange,
        ...
        self.switch_provider_radio_button = Button(
            master,
            text="Radio",
            command=self.switchToRadio,
            font=("EuroStyle", 15),
            anchor="center",
            bg="black",
            fg=EDOrange,
        ...
        self.switch_radio_station_button = Button(
            master,
            text="Channel",
            command=self.EDSR.nextRadioStation,
            font=("EuroStyle", 15),
            anchor="center",
            bg="black",
            fg=EDOrange,
